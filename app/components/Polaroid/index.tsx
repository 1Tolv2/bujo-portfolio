...
export function Polaroid({
  ...
  return (
    <div className="flex justify-center items-center">
      <div
        className={`relative flex flex-col justify-between gap-6 bg-mist-50 rounded-sm drop-shadow-lg p-5 xl:p-7
            ${mode === "portrait" ? "w-xs lg:w-sm h-120 lg:h-130" : "w-md xl:w-xl h-90 xl:h-110"}`}
      >
        <Tape />
